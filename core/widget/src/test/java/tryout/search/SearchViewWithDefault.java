...
public class SearchViewWithDefault extends BorderPane {

    public SearchViewWithDefault() {
        ...
        searchResults.setOnMouseClicked(FxOps.defaultMouseEventOf(searchResults.getSelectionModel(), Dl.local().lookup(Guardian.class)));
