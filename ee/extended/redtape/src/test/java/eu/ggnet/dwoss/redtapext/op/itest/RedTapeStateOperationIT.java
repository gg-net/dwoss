...
public class RedTapeStateOperationIT extends ArquillianProjectArchive {
    ...
    public void testStateError() throws InterruptedException {
        ...
        doc1 = redTapeWorker.stateChange(new CustomerDocument(new HashSet<>(), doc1, SIX_MIN_TEN, ADVANCE_PAYMENT), RedTapeStateTransitions.I_PAY_AND_INVOICE, "Test");
        ...
        doc1 = redTapeWorker.stateChange(new CustomerDocument(new HashSet<>(), doc1, SIX_MIN_TEN, ADVANCE_PAYMENT), RedTapeStateTransitions.I_PICK_UP, "Test");
        ...
        doc1 = redTapeWorker.stateChange(new CustomerDocument(new HashSet<>(), doc1, SIX_MIN_TEN, ADVANCE_PAYMENT), RedTapeStateTransitions.II_PAY, "Test");
        assertTrue("Set " + doc1.getConditions() + " should contain " + Document.Condition.PAID, doc1.getConditions().contains(Document.Condition.PAID));

        doc1 = redTapeWorker.stateChange(new CustomerDocument(new HashSet<>(), doc1, SIX_MIN_TEN, ADVANCE_PAYMENT), RedTapeStateTransitions.II_SEND_AND_INVOICE, "Test");
