...
/**
 * Reference mappe for PicoProduct to Product.
 *
 * @author oliver.guenther
 */
@ApplicationScoped
public class PicoProductMapper {

    @Inject
    @UniqueUnits
    private EntityManager em;

    public Product resolve(PicoProduct reference, @TargetType Class<Product> entityClass) {
