...
import eu.ggnet.dwoss.customer.ui.neo.mainView.CustomerContactController;
 ...
 */
public class CustomerContactTryout {
    public static void main(String[] args) {
        ...
        run.addActionListener(ev -> {
            Ui.fxml().show(CustomerContactController.class);
