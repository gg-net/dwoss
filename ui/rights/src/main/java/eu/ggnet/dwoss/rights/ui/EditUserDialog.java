...
/**
 * Invokes a specified {@link Dialog} pane with a {@link Label}, a {@link TextField} and {@link ListView} components to edit a {@link User}.
 * <p>
 * The modified User is the return value of the constructor, if a valid name is entered and the finish button is clicked, else the return value is null.
 *
 * @author mirko.schulze
 */
public class EditUserDialog extends Dialog<User> {

    private static final Logger L = LoggerFactory.getLogger(EditUserDialog.class);
        ...
        this.setResultConverter(type -> {
            if ( type == ButtonType.FINISH ) {
                User u = new User.Builder()
                        ...
                        .build();
                L.debug("Returning User {}", u.toString());
                return u;
            } else {
