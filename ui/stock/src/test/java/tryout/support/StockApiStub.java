...
public class StockApiStub implements StockApi {
    ...
    public List<Scraped> scrap(List<Long> stockUnitIds, String reason, String arranger) throws NullPointerException, UserInfoException {
        ...
        return stockUnitIds.stream().map(id -> new Scraped.Builder().uniqueUnitId(0).description("StockUnit(" + id + ")").comment("Ein Kommentar").successful(R.nextBoolean()).build()).collect(Collectors.toList());
    }
    ...
    public List<Scraped> delete(List<Long> stockUnitIds, String reason, String arranger) throws NullPointerException, UserInfoException {
        ...
        return stockUnitIds.stream().map(id -> new Scraped.Builder().uniqueUnitId(0).description("StockUnit(" + id + ")").comment("Ein Kommentar").successful(true).build()).collect(Collectors.toList());
    }
