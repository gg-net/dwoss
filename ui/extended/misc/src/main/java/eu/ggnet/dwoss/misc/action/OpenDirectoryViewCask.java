...
public class OpenDirectoryViewCask extends javax.swing.JPanel implements ToolbarComponent {

    static final URL OPEN_DIRECTORY_ICON = OpenDirectoryViewCask.class.getResource("fileopen_large.png");

    /** Creates new form OpenDirectoryViewCask */
    public OpenDirectoryViewCask() {
        initComponents();
        button.setIcon(new ImageIcon(OPEN_DIRECTORY_ICON));
    }
    ...
    private void initComponents() {
        ...
        button.setToolTipText("Dateisystem öffnen");
