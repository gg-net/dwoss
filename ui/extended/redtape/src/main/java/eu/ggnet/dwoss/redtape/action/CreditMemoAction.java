 ...
 * @author pascal.perau
 */
public class CreditMemoAction extends AccessableAction {
    ...
    public CreditMemoAction(Window parent, RedTapeController controller, Document doc, RedTapeStateTransition transition) {
        super(CREATE_CREDITMEMO);
        this.parent = parent;
        this.doc = doc;
