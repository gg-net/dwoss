...
/**
 * Informs about a successful scrapping operation of one or more units.
 *
 * @author oliver.guenther
 */
public class ScrapEvent implements Serializable {
    ...
    public ScrapEvent(List<Long> uniqueUnitIds, String arranger, String comment) {
    ...
    public String toString() {
        return "ScrapEvent{" + "uniqueUnitIds=" + uniqueUnitIds + ", arranger=" + arranger + ", comment=" + comment + '}';
    }
